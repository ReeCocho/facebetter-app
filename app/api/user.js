...
export const getChannels = async () => {
	...
	try {
		...
		let response = await fetch(buildPath(api/getchannels), {
			method: "POST",
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export const getMessages = async (channel, count, before = Date.now()) => {
	...
	try {
		const token = await AsyncStorage.getItem("token");
		let response = await fetch(buildPath("api/getmessages"), {
			method: "POST",
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export const getChannelMembers = async (channel, offset, count) => {
	...
	try {
		const token = await AsyncStorage.getItem("token");
		let response = await fetch(buildPath("api/listmembers"), {
			method: "POST",
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export const getChannelTitle = async (channel) => {
	...
	try {
		const token = await AsyncStorage.getItem("token");
		let response = await fetch(buildPath("api/getchanneltitle"), {
			method: "POST",
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export const getUsername = async (userId) => {
	...
	try {
		const token = await AsyncStorage.getItem("token");
		let response = await fetch(buildPath("api/customrequest"), {
			method: "POST",
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export const createNewChannel = async (title) => {
	...
	try {
		const token = await AsyncStorage.getItem("token");
		let response = await fetch(buildPath("api/createchannel"), {
			method: "POST",
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
...
export const createDM = async (otherUserId) => {
	try {
		const token = await AsyncStorage.getItem("token");
		let response = await fetch(buildPath("api/createdm"), {
			method: "POST",
			headers: {
				Accept: "application/json",
				"Content-Type": "application/json",
		...
		console.log("error creating new dm", error);
		return error;
	}
}